...
public class GetSpeakerTypeDetailsRequest : IRequest<SpeakerTypeDto>
{
    public Guid Id { get; private set; }
    public GetSpeakerTypeDetailsRequest(Guid id)
    {
        Id = id;
    }
    public class GetSpeakerTypeDetailsRequestHandler : IRequestHandler<GetSpeakerTypeDetailsRequest, SpeakerTypeDto>
    {
        private readonly IApplicationDbContext _context;
        public GetSpeakerTypeDetailsRequestHandler(IApplicationDbContext context)
        {
            _context = context;
        }
        public async Task<SpeakerTypeDto> Handle(GetSpeakerTypeDetailsRequest request, CancellationToken cancellationToken)
        {
            try
            {
