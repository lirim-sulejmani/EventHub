...
public class GetSpeakerListRequest : IRequest<SpeakerDto>
{
    public Guid Id { get; private set; }
    public GetSpeakerListRequest(Guid id)
    {
        Id = id;
    }
    public class GetSpeakerListRequestHandler : IRequestHandler<GetSpeakerListRequest, SpeakerDto>
    {
        private readonly IApplicationDbContext _context;
        public GetSpeakerListRequestHandler(IApplicationDbContext context)
        {
            _context = context;
        }
        public async Task<SpeakerDto> Handle(GetSpeakerListRequest request, CancellationToken cancellationToken)
        {
            try
            {
